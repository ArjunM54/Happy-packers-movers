        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-sky-50 rounded-full border border-sky-100">
              ...
              <span className="text-xs font-semibold text-sky-700 uppercase tracking-wide">Professional Moving & Logistics Services</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-6 leading-tight">
              Your Move.
              <br />
              Our <span className="text-sky-600">Responsibility</span>.
            </h1>

            {/* Supporting Text */}
            <p className="text-lg text-slate-700 mb-4 leading-relaxed">
              Reliable Packers & Movers, Logistics and Electrical Services for Homes, Offices and Businesses across all of India.
            </p>
            <p className="text-base text-slate-600 mb-8 leading-relaxed">
              From packing and shifting to transportation, storage, logistics and electrical services, we provide dependable solutions designed around your needs.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-primary">Certified & Trusted Service Provider</p>
                  <p className="text-sm text-slate-600">Professional commitment to your satisfaction</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-8">
              <img
                ...
                alt="Professional moving and logistics services"
